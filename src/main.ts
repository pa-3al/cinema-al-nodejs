...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .setDescription(
      "Comprehensive API for managing a cinema complex, including movies, screenings, rooms, and employees.",
    )
    .setVersion("1.0")
    .setContact(
      "Absolute Cinema Support",
      "https://absolute-cinema.com/support",
      "support@absolute-cinema.com",
    )
    .addBearerAuth(
      {
        type: "http",

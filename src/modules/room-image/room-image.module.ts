...
import {ROOM_IMAGE_REPOSITORY, ROOM_IMAGE_SERVICE, ROOM_REPOSITORY, STORAGE_PORT} from "src/core/domain/global/token";
...
import {SqlRoomRepository} from "../../infrastructure/adapters/persistence/sql/repositories/sql-room.repository";
